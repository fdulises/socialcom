CREATE TABLE IF NOT EXISTS pref_colecciones(
...
CREATE TABLE IF NOT EXISTS pref_comentarios(
...
CREATE TABLE IF NOT EXISTS pref_entradas(
	id INT(7) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS pref_intentosf(
	id INT(11) NOT NULL AUTO_INCREMENT,
	tiempo VARCHAR(10) NOT NULL,
	usuario INT(11) NOT NULL,
	PRIMARY KEY(id)
)DEFAULT CHARSET = UTF8;
CREATE TABLE IF NOT EXISTS pref_perfil(
	id INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS pref_sitio(
	id INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS pref_usuario(
	id INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS pref_sesiones(
	id INT(11) NOT NULL AUTO_INCREMENT,
	usuario INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS pref_publicaciones(
...
CREATE TABLE IF NOT EXISTS pref_follow(
	id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	autor INT(11) NOT NULL,
	destino INT(11) NOT NULL
)DEFAULT CHARSET = UTF8;
CREATE TABLE IF NOT EXISTS pref_likes(
	id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	autor INT(11) NOT NULL,
	destino INT(11) NOT NULL,
	tipo INT(1) NOT NULL
)DEFAULT CHARSET = UTF8;
CREATE TABLE IF NOT EXISTS pref_denuncias(
	id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	autor INT(11) NOT NULL,
	destino INT(11) NOT NULL,
	tipo INT(2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS pref_puntos(
	id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	autor INT(11) NOT NULL,
	destino INT(11) NOT NULL,
	tipo INT(1) NOT NULL,
...
CREATE TABLE IF NOT EXISTS pref_productos(
	id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS pref_logros(
	id INT(10) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	nombre VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS pref_logros_registro(
	id INT(10) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS pref_listascrap(
	id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	nombre VARCHAR(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS pref_pedidos(
	id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	nombre VARCHAR(150) NOT NULL,
	estado INT(1) NOT NULL DEFAULT 0
)DEFAULT CHARSET = UTF8;
CREATE TABLE IF NOT EXISTS pref_referidos(
	id INT(10) NOT NULL AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS pref_adds(
	id INT(10) NOT NULL AUTO_INCREMENT PRIMARY KEY,
	nombre VARCHAR(50) NOT NULL,
