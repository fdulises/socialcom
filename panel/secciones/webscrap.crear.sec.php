<?php
	...
	if( isset($_GET['guardar']) ){
		...
		if( isset( $_POST['nombre'], $_POST['url'] ) ){
			//Procesamos datos del producto
			if( !empty($_POST['nombre']) && !empty($_POST['url']) ){
				$result = webscrap::create([
					'nombre' => $_POST['nombre'],
					'url' => $_POST['url'],
					'estado' => 1,
				]);
...
?>
	<form class="container cont-700 cont-white mg-sec" id="form-webscrapcrear" method="post" action="?guardar">
		<h1>Agregar fuente webscrap</h1>
		<div class="form-sec">
