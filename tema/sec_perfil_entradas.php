<?php
	...
	$lista_articulos['entradas'] = extras::htmlentities($lista_articulos['entradas'], true);
	...
	$enlace_anterior = "{$mt->getInfo('url')}/@{$nickname}/entradas/{$lista_articulos['paginacion']['enlace_a']}";
	$enlace_siguiente = "{$mt->getInfo('url')}/@{$nickname}/entradas/{$lista_articulos['paginacion']['enlace_s']}";
